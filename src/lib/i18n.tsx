...
const translations = {
  en: {
    ...
    'wizard.upload.drag': 'Drag & drop your audio file here',
    'wizard.upload.or': 'or',
    'wizard.upload.browse': 'Browse files',
    'wizard.upload.formats': 'Supports MP3, WAV, M4A',
  ...
  zh: {
    ...
    'wizard.upload.drag': '拖放音频文件到这里',
    'wizard.upload.or': '或',
    'wizard.upload.browse': '选择文件',
    'wizard.upload.formats': '支持 MP3、WAV、M4A 格式',
